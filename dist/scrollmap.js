...
;(function ($, window, document, undefined) {
    ...
    Scrollmap.prototype = {
        ...
        mapLoad: function mapLoad(resolve) {
            ...
            this.options.geojson.features.forEach(function (marker) {
                var markerEl = document.createElement('div');
                markerEl.className = 'marker';

                new mapboxgl.Marker(markerEl).setLngLat(marker.geometry.coordinates).addTo(_this2.map);
            });
        },
        ...
        addScrollListener: function addScrollListener() {
            window.addEventListener('scroll', (0, _debounce3.default)(this.scrollHandler, 150), true);
        }
    };
...
},{"../config":1,"lodash/debounce":8}]},{},[14])(14)
});